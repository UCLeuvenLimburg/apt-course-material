...
It's a silly example, but you probably make similar mistakes without noticing, especially when it comes to factoring out *code*.



# map filter reduce max_by group_by
